...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-9ddc9db89b3a615c"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-9ddc9db89b3a615c",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-9ddc9db89b3a615c",
        "url": "https://en.wikipedia.org/wiki/Erd%C5%91s%E2%80%93Gy%C3%A1rf%C3%A1s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The Erdős–Gyárfás conjecture on cycles with power-of-two lengths in cubic graphs",
      "version": 1
    },
    "title": "Erdős–Gyárfás conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "487e7be25134f0f895a09044d17dc4869f639da8b4e98dd055834536b5925e1c"
}
```
